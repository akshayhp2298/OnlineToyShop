...
Partial Class Admin_Product_Category
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        cn.Open()
        cmb.CommandText = "SELECT MAX(category_id) from Category"
        cmb.Connection = cn
        Dim i As Integer = cmb.ExecuteScalar + 1
        cmb.CommandText = "Insert Into category Values(" & i & ",'" & TextBox1.Text & "')"
        cmb.Connection = cn
        cmb.ExecuteNonQuery()
        cn.Close()
        TextBox1.Text = ""
        Response.Redirect("/OnlineToyShop/Admin/Product/Category.aspx")
